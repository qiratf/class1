...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
    ...
    <?php } ?>
        ...
        if ( is_singular( 'attachment' ) ) {
            ...
            the_post_navigation( array(
                'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'herbal-ayurveda' ) . '</span> ' .
                    '<span class="screen-reader-text">' . __( 'Next post:', 'herbal-ayurveda' ) . '</span> ' .
                    '<span class="post-title">%title</span>',
                'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'herbal-ayurveda' ) . '</span> ' .
