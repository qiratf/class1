jQuery(document).ready(function($) {
    'use strict';
    var this_obj = herbal_ayurveda_plugin_activate_plugin;

    $('#gutenberg_editor .plugin-activation-redirect a').addClass('ive-redirect-to-dashboard');

    $(document).on('click', '.herbal-ayurveda-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message herbal-ayurveda-plugin-install');
                button.addClass('button-primary herbal-ayurveda-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.herbal-ayurveda-recommended-plugins .herbal-ayurveda-activation-note').css('display','block');
    ...
    $(document).on('click', '.herbal-ayurveda-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .herbal-ayurveda-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .herbal-ayurveda-recommended-plugins').css('display','none');
    });
